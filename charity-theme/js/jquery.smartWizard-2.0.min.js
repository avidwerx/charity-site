...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                var contentWidth = 0;
                var loader,msgBox,elmActionBar,elmStepContainer,btNext,btPrevious,btFinish,btSkip;
                ...
                function init(){
				  ...
				  btSkip = $('<a>Skip</a>').attr("href","#").addClass("buttonSkip");
                  ...
                  elmActionBar.append(btFinish).append(btNext).append(btPrevious).append(btSkip); 
